        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tarif = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeService = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Tarif = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Statut = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CoutTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
